      ...
      <div className="grid gap-6 md:grid-cols-3">
        {cardPacks.map((pack) => {
          ...
          return (
            ...
            >
              <CardHeader>
                <div className={`w-full h-32 bg-gradient-to-r ${pack.gradient} rounded-lg flex items-center justify-center mb-4`}>
                  <Icon className={`w-16 h-16 ${pack.textColor}`} />
                </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between pt-4 border-t">
                  ...
                  <Button
                    ...
                    className={`bg-gradient-to-r ${pack.gradient} hover:opacity-90`}
                  >
                    {loading ? '開啟中...' : '購買'}
                  </Button>
                </div>
